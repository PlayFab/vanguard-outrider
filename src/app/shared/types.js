...
export var DownloadProgress;
(function (DownloadProgress) {
    DownloadProgress[DownloadProgress["Waiting"] = 0] = "Waiting";
    DownloadProgress[DownloadProgress["Running"] = 1] = "Running";
    DownloadProgress[DownloadProgress["Finished"] = 2] = "Finished";
