			...
			case GridType.Grid4x4x4:
				return `
                    ...
                    ${
						props.reduce
							? `
                            @media ${is.null(props.breakpoint2) ? props.theme.breakpoint.small : props.breakpoint2} {
                    ...
                    @media ${is.null(props.breakpoint1) ? props.theme.breakpoint.medium : props.breakpoint1} {
                        grid-template-columns: 1fr 1fr 1fr;
                    }
                    ${is.null(props.columnGap) ? `` : `grid-column-gap: ${props.columnGap};`}
                `;
...
export const Grid: React.FunctionComponent<IGridProps> = React.memo(props => {
